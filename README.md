...
-f : Не сортировать содержимое каталога, включает опцию -a. Опции -l и -t игнорируются, если они заданы перед -f.
...
-1 : Вывод результата в одну колонку
```
***
...
S_IFSOCK 0140000 [s] сокет
S_IFLNK	0120000	[l] символьная ссылка
S_IFREG	0100000	[-] обычный файл
S_IFBLK	0060000	[b] блочное устройство
S_IFDIR	0040000	[d] каталог
S_IFCHR	0020000	[c] символьное устройство
S_IFIFO	0010000	[p] канал FIFO
